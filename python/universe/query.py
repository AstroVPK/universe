...
class JPLQuery(object):
    def __init__(self, object, format='json', obj_data=True, make_ephem=True, emphen_type='OBSERVER', center='500@0', start_time=None, stop_time=None, format_code="%Y-%m-%d %H:%M:%S", step_size='1d', orbital_period_regexes=None, mean_radius_regexes=None):
        ...
        self.orbital_period_regexes = orbital_period_regexes
        self.mean_radius_regexes = mean_radius_regexes        
